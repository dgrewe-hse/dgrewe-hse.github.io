...
Every conversation about AI and software engineering, regardless of whether I talk to industry professionals or students, eventually narrows to the same question: will AI take my job sooner or later? It's an understandable question, and not an unimportant one. But after talking to several representatives in the last few weeks, I think it's the wrong question to be asking first.
...
*The five categories of software business models affected by generative AI — each built on a different link in the production value chain.*
...
When an AI coding assistant can generate a bespoke, purpose-fit component in minutes instead of licensing a general-purpose one for a five-figure annual fee, the calculus flips. You get exactly what you need instead of 5% of a sprawling feature set you're paying to maintain compatibility with. The vendors who see this clearly are already repositioning — away from selling building blocks and toward selling hosted infrastructure, support contracts, and the operational layer that AI-generated code still can't provide on its own. The ones who haven't repositioned yet are the ones quietly not showing their old product on the trade show floor anymore.

## Vibe coding and the standard software vendors

"Vibe coding" — building working applications with essentially no traditional programming background, just AI-assisted iteration — is easy to dismiss as a toy for small internal tools. I don't think that dismissal survives contact with what's actually happening. People with zero formal training are replacing shop systems, CRM instances, and ERP modules with self-built alternatives, specifically to avoid licensing costs. The quality of the resulting code is inconsistent, sometimes genuinely fine, sometimes a mess — but that's a temporary state, not a structural limit.
...
For software consultancies — arguably the largest segment of the industry — the shift is structural rather than existential, but no less disruptive. Pure coding capacity used to be a billable line item. It's rapidly becoming a commodity that clients can partially self-serve. I'm hearing this directly from clients who are service providers themselves: contracts shrinking not primarily because of the economic cycle, but because their own customers now say, explicitly, "we don't need that feature built externally anymore — we have people in-house who can do it with AI."

What doesn't commoditize as fast: **requirements elicitation** from a client who doesn't actually know what they want yet, deployment and operational ownership, and — this is the one I'd bet on most — **quality assurance**. Generating large amounts of functional-looking code quickly is now easy. Standing behind it, verifying it actually does what it claims, and being the accountable party when it doesn't, is not easy. AI doesn't remove that need. If anything, it makes it more acute, because the volume of generated code that needs verifying has gone up by an order of magnitude while the rigor applied to verifying it mostly hasn't.
...
## What actually survives across all categories

Line up every category and subtract the part of each business that was really just "we have people who can produce working code, and that's scarce." What's left, every time, is some version of the same thing: **judgment about what to build, accountability for whether it actually works, and the trust relationship** that lets a client or a business unit hand off a problem and know someone competent is answering for the outcome.

That's not a comforting conclusion if your business model was built entirely on production capacity. But it is, I think, an accurate one — and it points toward where the defensible value sits over the next several years. Production is getting commoditized. Verification and accountability are not, and they're becoming the scarcer resource precisely because production volume is exploding around them.

Most companies in this industry haven't internalized that yet. The conference floor was full of AI-adjacent messaging and remarkably light on anyone who had actually rebuilt their pricing or their org chart around this shift. That gap — between how fast the underlying economics are moving and how slowly business strategy is catching up — is the real story here. Not "AI writes code now." We've known that for a while. It's that an entire industry's worth of pricing models were quietly built on an assumption that just stopped being true, and most of the companies affected haven't noticed yet.
